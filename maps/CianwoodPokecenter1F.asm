...
CianwoodPokecenter1F_MapEvents:
	...
	def_object_events
	object_event  3,  1, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_YELLOE, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, CianwoodPokecenter1FNurseScript, -1
