...
; Map events
	...
	add_special CheckForLuckyNumberWinners ; retired compatibility stub
	add_special CheckLuckyNumberShowFlag
	add_special ResetLuckyNumberShowFlag
	add_special PrintTodaysLuckyNumber ; retired compatibility stub
