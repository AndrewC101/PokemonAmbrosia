...
Route35_MapEvents:
	...
	;object_event 14, 28, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBirdKeeperBryan, -1
	...
	object_event 0, 16, SPRITE_AMPHAROS, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, Route35FieldMon3Script, EVENT_FIELD_MON_3
