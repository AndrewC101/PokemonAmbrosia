...
DragonShrine_MapEvents:
	...
	def_object_events
	object_event  5,  1, SPRITE_ELDER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, DragonShrineElder1Script, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
