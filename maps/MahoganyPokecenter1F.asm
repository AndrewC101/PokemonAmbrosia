...
MahoganyPokecenter1F_MapEvents:
	...
	object_event  1,  3, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, MahoganyPokecenter1FYoungsterScript, -1
