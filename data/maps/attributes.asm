...
ENDM
	...
	connection east, Route27, ROUTE_27, 5

	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $05, NORTH | WEST | EAST
	connection north, Route30, ROUTE_30, 5
	connection west, CherrygroveBay, CHERRYGROVE_BAY, -7
	connection east, Route29, ROUTE_29, 1

	map_attributes CherrygroveBay, CHERRYGROVE_BAY, $05, WEST | EAST
	...
	connection south, Route34, ROUTE_34, 3
	...
	connection east, CherrygroveBay, CHERRYGROVE_BAY, 20
	...
	connection north, GoldenrodCity, GOLDENROD_CITY, -3
	...
	connection south, OlivineCity, OLIVINE_CITY, -2
	...
	connection west, CianwoodCity, CIANWOOD_CITY, -4
	...
	connection south, Route2, ROUTE_2, 1
	connection east, Route3, ROUTE_3, 5

	map_attributes Route2, ROUTE_2, $0f, NORTH | SOUTH
	connection north, PewterCity, PEWTER_CITY, -1
	connection south, ViridianCity, VIRIDIAN_CITY, -1

	map_attributes ViridianCity, VIRIDIAN_CITY, $0f, NORTH | SOUTH | WEST
	connection north, Route2, ROUTE_2, 1
	...
	map_attributes HallOfOrigin, HALL_OF_ORIGIN, $3F, SOUTH
	connection south, OriginRoad, ORIGIN_ROAD, 3

	map_attributes OriginRoad, ORIGIN_ROAD, $3F, NORTH | SOUTH
	connection north, HallOfOrigin, HALL_OF_ORIGIN, -3
	connection south, OriginRoadSouth, ORIGIN_ROAD_SOUTH, 0

	map_attributes OriginRoadSouth, ORIGIN_ROAD_SOUTH, $3F, NORTH
	connection north, OriginRoad, ORIGIN_ROAD, 0
	...
	map_attributes SeafoamCave, SEAFOAM_CAVE, $3b, 0
	...
	map_attributes HeroesPass, HEROES_PASS, $0f, 0
	map_attributes HeroesPassCaves, HEROES_PASS_CAVES, $09, 0
	...
	map_attributes ViridianForest, VIRIDIAN_FOREST, $87, 0
	...
	map_attributes CherrygroveRuins, CHERRYGROVE_RUINS, $00, 0
	...
	map_attributes DestinyPark2, DESTINY_PARK_2, $00, 0
	map_attributes AncientRuinPresent, ANCIENT_RUIN_PRESENT, $0A, 0
	map_attributes AncientRuinPast, ANCIENT_RUIN_PAST, $89, 0
