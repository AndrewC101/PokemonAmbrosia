...
SilverCaveRoom3_MapEvents:
	...
	object_event  5, 11, SPRITE_DRAGONITE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon1Script, EVENT_FIELD_MON_1
	object_event 14, 11, SPRITE_TYRANITAR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon2Script, EVENT_FIELD_MON_2
