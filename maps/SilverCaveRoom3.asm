...
SilverCaveRoom3_MapEvents:
	...
	def_object_events
	object_event  8, 10, SPRITE_RED, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Red, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
	object_event 11, 10, SPRITE_RED, SPRITEMOVEDATA_STANDING_LEFT,  0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Ash, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
	object_event  8, 9, SPRITE_PIKACHU, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Pikachu, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
	object_event 11, 9, SPRITE_PIKACHU, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Pikachu, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
	object_event  8, 19, SPRITE_DRAGONITE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon1Script, EVENT_FIELD_MON_1
	...
	object_event  7, 10, SPRITE_MEWTWO, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3MewtwoScript, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
	object_event 12, 10, SPRITE_HO_OH, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3HoohScript, EVENT_SILVER_CAVE_ROOM_3_MT_SILVER_SCENE_HIDDEN
