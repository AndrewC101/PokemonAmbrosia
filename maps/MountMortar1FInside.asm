...
MountMortar1FInside_MapEvents:
	...
	object_event  8, 39, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideMaxRevive, EVENT_MOUNT_MORTAR_1F_INSIDE_MAX_REVIVE
	...
	object_event 16, 18, SPRITE_CONKELDURR, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MountMortar1FInsideFieldMon6Script, EVENT_FIELD_MON_6
	object_event 31, 29, SPRITE_MACHAMP, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, MountMortar1FInsideFieldMon7Script, EVENT_FIELD_MON_7
	object_event 31, 17, SPRITE_ELECTABUZZ, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, MountMortar1FInsideFieldMon8Script, EVENT_FIELD_MON_8
