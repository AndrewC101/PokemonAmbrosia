...
GoldenrodMagnetTrainStation_MapEvents:
	...
	def_object_events
	object_event  9,  9, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, GoldenrodMagnetTrainStationOfficerScript, -1
