...
ManorFact8Text:
	text "A lot of work has"
	line "been done to DVs."
	para "When you use"
	line "Ambrosia there are"
	cont "5 possible DV"
	cont "spreads it can"
	cont "set."
	para "Perfect Genderless"
	line "15,15,15,15."
	para "Perfect Male"
	line "15,15,15,14."
	para "Perfect Female"
	...
	para "Shiny Female"
	line "15,12,15,15."
	para "Then during stat"
	line "calculation any"
	cont "defense value of"
	cont "12 or more is"
	cont "treated as 15, and"
	cont "any special values"
	cont "of 14 or more is"
	cont "treated as 15."
	para "The HP DV has been"
	line "also changed, it"
	cont "used to be based"
	cont "on all other DVs"
	cont "but now is just"
	cont "equal to the"
	cont "attack DV."
	para "This all means"
	line "that any #mon"
	cont "can have true max"
	cont "stats regardless"
	cont "of gender or"
	cont "shininess."
	done
...
ManorFact19Text:
	text "There used to be a"
	line "bug where catching"
	cont "an aggressive"
	cont "overworld mon and"
	cont "having it sent to"
	cont "the box would"
	cont "crash the game."
	para "In the end I used"
	line "Codex to fix it."
	para "Issue was the OT"
	line "name shares the"
	cont "same memory"
	cont "address as enemy"
	cont "trainer"
	cont "attributes."
	para "Normally they"
	line "never interact as"
	cont "wild battles and"
	cont "trainer battles"
	cont "are separate."
	para "But red overworld"
	line "mon are both."
	para "Codex was able to"
	line "restore the"
	cont "corrupted trainer"
	cont "attributes in the"
	cont "flow."
	para "I would never have"
	line "found that by"
	cont "myself."
	done
...
ManorFact6Text:
	...
	cont "from the start."
	para "That led to"
	line "creating Gift Of"
	cont "God as a better"
	cont "prize for full"
	cont "#dex"
	cont "completion."
	para "But it was too fun"
	line "to use, so that"
	cont "led to Mr Mime"
	cont "cheats so players"
	cont "could use it"
	cont "early."
	para "But it made the"
	line "game too easy so"
	cont "that led to Hard"
	cont "mode."
	para "But difficulty"
	line "modes add"
	cont "replayability so"
	cont "that led to new"
	cont "game plus being"
	cont "added."
	para "You never know"
	line "where an idea"
	cont "might lead."
...
ManorInside_MapEvents:
	...
	object_event  3, 41, SPRITE_SABRINA, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, WifeScript, -1
