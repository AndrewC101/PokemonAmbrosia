...
Route21_MapEvents:
	...
	object_event  3, 25, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon1Script, EVENT_FIELD_MON_1
	...
	object_event  6, 27, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon3Script, EVENT_FIELD_MON_3
	object_event 10, 29, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon4Script, EVENT_FIELD_MON_4
