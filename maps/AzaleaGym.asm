...
AzaleaGymHeracrossScript:
    opentext
    writetext HeracrossText
    cry HERACROSS
    waitbutton
    closetext
    end
...
AzaleaGym_MapEvents:
	...
	object_event  7, 13, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, AzaleaGymGuideScript, -1
	object_event  4,  7, SPRITE_HERACROSS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AzaleaGymHeracrossScript, -1
