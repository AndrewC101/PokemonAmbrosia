...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event 40,  5, SPRITE_DRAGON, SPRITEMOVEDATA_WANDER, 3, 3, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, DarkCaveBlackthornEntranceFieldMon3Script, EVENT_FIELD_MON_3
