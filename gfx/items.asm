...
KurtsMapIcon::	      INCBIN "gfx/items/KurtsMap.2bpp.lz"
LemonadeKIcon::	  	  INCBIN "gfx/items/lemonade.2bpp.lz"
RagecandybarKIcon::	  INCBIN "gfx/items/ragecandybar.2bpp.lz"
BigMushroomKIcon::	  INCBIN "gfx/items/big_mushroom.2bpp.lz"
LiteBlueMailKIcon::	  INCBIN "gfx/items/mail.2bpp.lz"
GoldLeafKIcon::	   INCBIN "gfx/items/leaf.2bpp.lz"
SurfMailKIcon::	   INCBIN "gfx/items/mail.2bpp.lz"
OldAmberKIcon::   INCBIN "gfx/items/old_amber.2bpp.lz"
...
AmbrosiaIcon::	   INCBIN "gfx/items/old_amber.2bpp.lz"
