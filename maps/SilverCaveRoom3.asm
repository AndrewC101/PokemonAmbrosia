...
SilverCaveRoom3_MapEvents:
	...
	object_event 14, 11, SPRITE_DRAGONITE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon1Script, EVENT_FIELD_MON_1
	object_event  5, 11, SPRITE_TYRANITAR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon2Script, EVENT_FIELD_MON_2
	object_event 14, 13, SPRITE_SALAMENCE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon3Script, EVENT_FIELD_MON_3
	object_event  5, 13, SPRITE_METAGROSS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom3FieldMon4Script, EVENT_FIELD_MON_4
