	...
	; tm/hm learnset
	tmhm DRAIN_PUNCH, HEADBUTT, BODY_SLAM, CURSE, ROAR, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, SUBSTITUTE, IRON_HEAD, DRAGON_PULSE, EARTHQUAKE, EARTH_POWER, RETURN, DOUBLE_EDGE, DIG, SLEEP_TALK, SANDSTORM, FIRE_BLAST, SWIFT, REST,  FIRE_PUNCH, CUT, FLY, STRENGTH, FLAMETHROWER, ROOST, SWORDS_DANCE, ROCK_SLIDE, THUNDERPUNCH, FLASH
	; end
