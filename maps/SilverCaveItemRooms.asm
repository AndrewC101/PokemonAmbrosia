...
SilverCaveItemRooms_MapEvents:
	...
	def_object_events
	object_event 17,  2, SPRITE_PALKIA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PalkiaScript, EVENT_CAUGHT_PALKIA
	object_event 30,  2, SPRITE_DIALGA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, DialgaScript, EVENT_CAUGHT_DIALGA
	object_event 29,  9, SPRITE_LUCARIO, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon1Script, EVENT_FIELD_MON_1
	object_event 18,  9, SPRITE_ALAKAZAM, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon2Script, EVENT_FIELD_MON_2
	...
	object_event 39,  7, SPRITE_MISMAGIUS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon4Script, EVENT_FIELD_MON_4
	...
	object_event 10, 12, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon7Script, EVENT_FIELD_MON_7
	object_event  7,  4, SPRITE_MILOTIC, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon8Script, EVENT_FIELD_MON_8
	object_event  9, 15, SPRITE_DRACOVISH, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon9Script, EVENT_FIELD_MON_9
	object_event 17, 15, SPRITE_ARCTOZOLT, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveItemRoomFieldMon10Script, EVENT_FIELD_MON_10
