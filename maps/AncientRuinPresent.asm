...
AncientRuinPresent_MapEvents:
	...
	object_event 29, 36, SPRITE_GENESECT, SPRITEMOVEDATA_POKEMON, 3, 3, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, AncientRuinsPresentFieldMon4Script, EVENT_FIELD_MON_4
