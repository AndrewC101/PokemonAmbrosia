...
MountMortar1FOutside_MapEvents:
	...
	object_event 31, 28, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 2, MountMortar1FOutsideFieldMon2Script, EVENT_FIELD_MON_2
	object_event  7, 25, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, MountMortar1FOutsideFieldMon3Script, EVENT_FIELD_MON_3
