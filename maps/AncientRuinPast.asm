...
AncientRuinPast_MapEvents:
	...
	object_event 20, 34, SPRITE_METAGROSS, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, AncientRuinPastFieldMon8Script, EVENT_FIELD_MON_8
	object_event 19,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, AncientRuinsPastAmbrosia, EVENT_ANCIENT_RUINS_PAST_AMBROSIA
