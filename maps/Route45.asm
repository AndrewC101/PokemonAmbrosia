...
Route45_MapEvents:
	...
	object_event 14, 82, SPRITE_DRAGON, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route45FieldMon6Script, EVENT_FIELD_MON_6
