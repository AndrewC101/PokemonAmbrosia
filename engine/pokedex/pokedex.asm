...
DEF DEXSEARCH_SOURCE_TYPE         EQU 0
DEF DEXSEARCH_SOURCE_CURRENT_AREA EQU $ff
...
String_SELECT_OPTION:
	db $3b, $48, $49, $4a, $44, $45, $46, $47 ; PAD_SELECT > OPTION
	; fallthrough
String_START_SEARCH:
