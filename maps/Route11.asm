...
Route11_MapEvents:
	...
	object_event 19,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route11FieldMon5Script, EVENT_FIELD_MON_5
	object_event 20,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route11FieldMon6Script, EVENT_FIELD_MON_6
