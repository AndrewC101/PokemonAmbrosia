...
WhirlIslandB2F_MapEvents:
	...
	def_object_events
	object_event  6,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB2FFullRestore, EVENT_LUGIA_AMBROSIA
	...
	object_event  9,  4, SPRITE_BAXCALIBUR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 2, WhirlIslandB2FFieldMon1Script, EVENT_FIELD_MON_1
