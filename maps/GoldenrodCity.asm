...
GoldenrodCityFieldMon1Script:
	trainer HAUNTER, FIELD_MON, EVENT_FIELD_MON_1, GoldenrodCityPokemonAttacksText, 30, 0, .script
.script
    disappear GOLDENRODCITY_FIELDMON_1
    end
...
GoldenrodCity_MapEvents:
	...
	object_event 30, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, GoldenrodCityYoungster1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 12, 16, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event 7, 16, SPRITE_SELECTED_PLAYER, SPRITEMOVEDATA_STANDING_LEFT, 2, 2, -1, -1, PAL_NPC_PLAYER, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMP_EVENT_1
