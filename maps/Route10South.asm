...
Route10South_MapEvents:
	...
	def_warp_events
	warp_event  8,  4, LAVENDER_FOREST, 1
	warp_event  9,  4, LAVENDER_FOREST, 2
	...
	def_object_events
	object_event 17,  4, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerHikerJim, -1
	...
	object_event  5, 10, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, Route10SouthFieldMon5Script, EVENT_FIELD_MON_4
