...
MapGroup_Mahogany:
	...
	map Route44, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_44, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Dungeons:
	...
	map SproutTowerB1F, TILESET_TOWER, CAVE, LANDMARK_SPROUT_TOWER, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	...
	map NationalParkBugContest, TILESET_PARK, ROUTE, LANDMARK_NATIONAL_PARK, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, RADIO_TOWER_MUSIC, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, RADIO_TOWER_MUSIC, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower3F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, RADIO_TOWER_MUSIC, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower4F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, RADIO_TOWER_MUSIC, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower5F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, RADIO_TOWER_MUSIC, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map WhirlIslandLugiaChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_LUGIA_SONG, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_WHIRL_ISLANDS
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_ICE_PATH, DUNGEON, LANDMARK_SILVER_CAVE, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map DarkCaveVioletEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_RED_DUNGEON, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_RED_DUNGEON, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	...
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ElementCave, TILESET_CAVE, CAVE, LANDMARK_ELEMENT_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_MORN, FISHGROUP_SHORE
	map CeruleanCave, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RED_DUNGEON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map AncientTemple, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_TIN_TOWER, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map AncientHall, TILESET_LAB, CAVE, LANDMARK_SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map OldLighthouse, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_CAPE_STORM, MUSIC_LIGHTHOUSE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map AncientHallStairs, TILESET_CAVE, CAVE, LANDMARK_LAKE_TOHJO, MUSIC_TIN_TOWER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	assert_table_length NUM_DUNGEONS_MAPS

MapGroup_Ecruteak:
	table_width MAP_LENGTH, MapGroup_Ecruteak
	map EcruteakTinTowerEntrance, TILESET_TOWER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WiseTriosRoom, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map EcruteakLugiaSpeechHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map EcruteakMart, TILESET_MART, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EcruteakGym, TILESET_TOWER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map EcruteakItemfinderHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EcruteakCity, TILESET_JOHTO, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_LUGIA_SONG, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_45, MUSIC_MISTY_MOUNTAIN, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_46, MUSIC_MISTY_MOUNTAIN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map CinnabarLab, TILESET_FACILITY, DUNGEON, LANDMARK_CINNABAR_LAB, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_NONE
	map SeafoamCave, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map LakeOfRageHiddenPowerHouse, TILESET_HOUSE, DUNGEON, LANDMARK_LAKE_OF_RAGE, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map Route32, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_GARCHOMP
	...
	map Route37, TILESET_JOHTO, CAVE, LANDMARK_ROUTE_37, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map VioletPokecenter2F, TILESET_POKECENTER, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_POKEMON_CENTER, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Pewter:
	...
	map PewterCity, TILESET_KANTO, TOWN, LANDMARK_PEWTER_CITY, MUSIC_MAD_WORLD, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterNidoranSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterGym, TILESET_TOWER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMart, TILESET_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	;map PewterPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterSnoozeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map FastShip1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FastShipCabins_NNW_NNE_NE, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FastShipCabins_SW_SSW_NW, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FastShipCabins_SE_SSE_CaptainsCabin, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FastShipB1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map Route23, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route13, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_GARCHOMP_NO_SWARM
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_GARCHOMP_NO_SWARM
	map Route10South, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map LavenderTown, TILESET_KANTO, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map MrFujisHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderNameRater, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderMart, TILESET_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SoulHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_RADIO_TOWER, MUSIC_RED_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderForest, TILESET_JOHTO, CAVE, LANDMARK_LAVENDER_FOREST, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_LAVENDER_MAPS

MapGroup_Silver:
	table_width MAP_LENGTH, MapGroup_Silver
	map Route28, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_28, MUSIC_MISTY_MOUNTAIN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCaveOutside, TILESET_KANTO, TOWN, LANDMARK_SILVER_CAVE, MUSIC_MISTY_MOUNTAIN, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCavePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SILVER_CAVE, MUSIC_MISTY_MOUNTAIN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route28SteelWingHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_28, MUSIC_MISTY_MOUNTAIN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map Route40BattleTowerGate, TILESET_GATE, GATE, LANDMARK_BATTLE_TOWER, MUSIC_ROUTE_36, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map HeroesPass, TILESET_CAVE, CAVE, LANDMARK_HEROES_PASS, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map HeroesPassCaves, TILESET_CAVE, CAVE, LANDMARK_HEROES_PASS, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map TrainerHouseB1F, TILESET_BATTLE_TOWER_INSIDE, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_KANTO, INDOOR, LANDMARK_VIRIDIAN_FOREST, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_NewBark:
	...
	map CapeStorm, TILESET_JOHTO, ROUTE, LANDMARK_CAPE_STORM, MUSIC_DRAGONS_DEN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CapeStormRoute21Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map TohjoLake, TILESET_JOHTO, ROUTE, LANDMARK_LAKE_TOHJO, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Saffron:
	...
	map GiovanniGym, TILESET_TOWER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveBay, TILESET_JOHTO, ROUTE, LANDMARK_CHERRYGROVE_BAY, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CherrygroveRuins, TILESET_RUINS_OF_ALPH, INDOOR, LANDMARK_CHERRYGROVE_BAY, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_CHERRYGROVE_MAPS

MapGroup_DestinyTower:
	table_width MAP_LENGTH, MapGroup_DestinyTower
	map DestinyPark, TILESET_BATTLE_TOWER_OUTSIDE, INDOOR, LANDMARK_DESTINY_TOWER, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map DestinySquare, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_DESTINY_TOWER, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map DestinyFrontier, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, LANDMARK_DESTINY_TOWER, MUSIC_ROUTE_26, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map DestinyEliteFour, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_DESTINY_TOWER, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map DestinyPark2, TILESET_BATTLE_TOWER_OUTSIDE, INDOOR, LANDMARK_DESTINY_TOWER, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_DESTINY_TOWER_MAPS

MapGroup_HallOfOrigin:
	table_width MAP_LENGTH, MapGroup_HallOfOrigin
	map HallOfOrigin, TILESET_PARK, ROUTE, LANDMARK_HALL_OF_ORIGIN, MUSIC_LUGIA_SONG, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map OriginRoad, TILESET_PARK, ROUTE, LANDMARK_HALL_OF_ORIGIN, MUSIC_TIN_TOWER, TRUE, PALETTE_DAY, FISHGROUP_NONE
    map OriginRoadSouth, TILESET_PARK, ROUTE, LANDMARK_HALL_OF_ORIGIN, MUSIC_TIN_TOWER, TRUE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_HALL_OF_ORIGIN_MAPS

MapGroup_AncientRuin:
	table_width MAP_LENGTH, MapGroup_AncientRuin
	map AncientRuinPresent, TILESET_JOHTO, CAVE, LANDMARK_ANCIENT_RUIN, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map AncientRuinPast, TILESET_JOHTO, ROUTE, LANDMARK_ANCIENT_RUIN, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_EVE, FISHGROUP_NONE
	assert_table_length NUM_ANCIENT_RUIN_MAPS

MapGroup_WarZone:
    table_width MAP_LENGTH, MapGroup_WarZone
	map WarZone, TILESET_JOHTO, ROUTE, LANDMARK_WAR_ZONE, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_AUTO, FISHGROUP_NONE
    assert_table_length NUM_WAR_ZONE_MAPS

MapGroup_Museum:
    table_width MAP_LENGTH, MapGroup_Museum
	map Museum, TILESET_GATE, CAVE, LANDMARK_MUSEUM, MUSIC_CINNABAR_MANSION, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_NONE
