	...
	const SILVERCAVEROOM2_POKE_BALL4
	const SILVERCAVEROOM2_POKE_BALL5
	const SILVERCAVEROOM2_POKE_BALL6
...
SilverCaveRoom2Ambrosia1:
	itemball AMBROSIA

SilverCaveRoom2Ambrosia2:
	itemball AMBROSIA

SilverCaveRoom2Ambrosia3:
	itemball AMBROSIA
...
SilverCaveRoom2_MapEvents:
	...
	def_object_events
	object_event 24, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2Calcium, EVENT_SILVER_CAVE_ROOM_2_CALCIUM
	object_event 22, 48, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2UltraBall, EVENT_SILVER_CAVE_ROOM_2_ULTRA_BALL
	object_event  4, 44, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2PPUp, EVENT_SILVER_CAVE_ROOM_2_PP_UP
	object_event 11,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2Ambrosia1, EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_1
	object_event 19, 28, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2Ambrosia2, EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_2
	object_event 10, 38, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2Ambrosia3, EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_3
