...
SlowpokeWellB2F_MapEvents:
	...
	object_event 5, 2, SPRITE_SLOWKING, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB2FFieldMon1Script, EVENT_FIELD_MON_1
	object_event 4, 4, SPRITE_SLOWBRO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB2FFieldMon2Script, EVENT_FIELD_MON_2
	object_event 4, 6, SPRITE_SLOWBRO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB2FFieldMon3Script, EVENT_FIELD_MON_3
	object_event 7, 4, SPRITE_SLOWBRO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB2FFieldMon4Script, EVENT_FIELD_MON_4
	object_event 7, 6, SPRITE_SLOWBRO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB2FFieldMon5Script, EVENT_FIELD_MON_5
