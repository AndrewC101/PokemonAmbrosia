...
SlowpokeWellB1F_MapEvents:
	...
	object_event  3,  2, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB1FFieldMon1Script, SLOWPOKEWELLB1F_FIELDMON_1
