...
Route21_MapEvents:
	...
	def_warp_events
	warp_event  4, 20, CAPE_STORM_ROUTE_21_GATE, 3
	warp_event  4, 21, CAPE_STORM_ROUTE_21_GATE, 4
	...
	object_event 11, 31, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon1Script, EVENT_FIELD_MON_1
	object_event 16, 15, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon2Script, EVENT_FIELD_MON_2
	object_event  5, 29, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon3Script, EVENT_FIELD_MON_3
	object_event  9, 29, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route21FieldMon4Script, EVENT_FIELD_MON_4
