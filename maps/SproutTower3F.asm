...
SproutTower3F_MapEvents:
	...
	object_event 10,  2, SPRITE_ELDER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SageLiScript, -1
	...
	object_event  8, 11, SPRITE_LITWICK, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 2, SproutTower3FFieldMon1Script, EVENT_FIELD_MON_1
