...
DarkCaveBlackthornEntranceFieldMon3Script:
	trainer WEEZING, FIELD_MON, EVENT_FIELD_MON_3, DarkCaveBlackthornEntrancePokemonAttacksText, 64, 0, .script
.script
...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event 40,  5, SPRITE_HYDREIGON, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, DarkCaveBlackthornEntranceFieldMon3Script, EVENT_FIELD_MON_3
