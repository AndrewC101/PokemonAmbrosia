    ...
    const SILVERCAVEOUTSIDE_RPG_NPC
...
.spawn
	...
	iftrue .ShowRPGNPC
	disappear SILVERCAVEOUTSIDE_RPG_NPC
	endcallback

.ShowRPGNPC:
	appear SILVERCAVEOUTSIDE_RPG_NPC
	endcallback
...
SilverCaveOutside_MapEvents:
	...
	object_event 19, 16, SPRITE_BEAUTY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMP_EVENT_2
	...
	object_event 26, 19, SPRITE_WILL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 1, HoenWarRolePlayScript, EVENT_SILVER_CAVE_OUTSIDE_RPG_NPC_HIDDEN
