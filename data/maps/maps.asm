...
MapGroup_Dungeons:
	...
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MAD_WORLD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MAD_WORLD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
