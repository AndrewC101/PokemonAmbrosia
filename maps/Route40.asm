...
Route40_MapEvents:
	...
	object_event 10, 21, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, AreaFieldMon1Script, EVENT_FIELD_MON_1
	object_event  3, 30, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, AreaFieldMon2Script, EVENT_FIELD_MON_2
	object_event 14, 32, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, AreaFieldMon3Script, EVENT_FIELD_MON_3
