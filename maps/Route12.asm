...
Route12_MapEvents:
	...
	object_event  8, 32, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, Route12FieldMon7Script, EVENT_FIELD_MON_7
