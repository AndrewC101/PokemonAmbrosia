...
Route44FieldMon1Script:
	trainer ARBOK, FIELD_MON, EVENT_FIELD_MON_1, Route44PokemonAttacksText, 54, 0, .script
.script
    disappear ROUTE44_FIELDMON_1
    end

Route44FieldMon2Script:
	trainer WEAVILE, FIELD_MON, EVENT_FIELD_MON_2, Route44PokemonAttacksText, 55, 0, .script
.script
...
Route44_MapEvents:
	...
	object_event 44,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 3, 3, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route44FieldMon1Script, EVENT_FIELD_MON_1
	object_event 52, 16, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 3, 3, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route44FieldMon2Script, EVENT_FIELD_MON_2
	object_event 29,  2, SPRITE_CHANSEY, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route44FieldMon3Script, EVENT_FIELD_MON_3
	object_event 22,  8, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route44FieldMon4Script, EVENT_FIELD_MON_4
	object_event 26, 15, SPRITE_MILOTIC, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route44FieldMon5Script, EVENT_FIELD_MON_5
	object_event 37,  9, SPRITE_TOGEKISS, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route44FieldMon6Script, EVENT_FIELD_MON_6
	object_event 51,  4, SPRITE_ABOMASNOW, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route44FieldMon7Script, EVENT_FIELD_MON_7
