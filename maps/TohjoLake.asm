...
TohjoLake_MapEvents:
	...
	def_object_events
	object_event 21, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TohjoLakeLatiosTrainerScript, EVENT_CAUGHT_LATIOS
	object_event  5,  8, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TohjoLakeTrainerSeto, -1
