...
DEF TRAINERTYPE_PALETTE    EQU 1 << TRAINERTYPE_PALETTE_F

DEF PERFECT_DV EQU $11 ; treated as $FF in enemy party data
DEF PERFECT_STAT_EXP EQU $1337 ; treated as $FFFF in enemy party data

DEF FIELD_MON EQU $FF ; Flag to indicate a trainer object should behave as a wild Pokemon encounter
