	...
	const WARZONE_GROUDON
	const WARZONE_RAYQUAZA
...
.battle
	...
	disappear WARZONE_GROUDON
	disappear WARZONE_RAYQUAZA
	dontrestartmapmusic
...
WarZone_MapEvents:
	...
	object_event 15,  4, SPRITE_CLAIR, SPRITEMOVEDATA_STANDING_RIGHT, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, CynthiaScript, EVENT_FIELD_MON_8
	...
	object_event 21, 10, SPRITE_BEAUTY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMP_EVENT_2
	...
	object_event 20, 18, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, JonathanScript, -1
