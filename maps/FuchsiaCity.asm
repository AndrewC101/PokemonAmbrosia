...
FuchsiaCity_MapEvents:
	...
	object_event  6,  6, SPRITE_DRATINI, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FuchsiaCityMon2Script, EVENT_FIELD_MON_2
	object_event 28, 23, SPRITE_GIBLE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FuchsiaCityMon3Script, EVENT_FIELD_MON_3
