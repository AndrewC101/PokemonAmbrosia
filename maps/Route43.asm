...
Route43_MapEvents:
	...
	object_event 12, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, Route43MaxEther, EVENT_ROUTE_43_MAX_ETHER
	...
	object_event 19,  28, SPRITE_AMPHAROS, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, Route43FieldMon4Script, EVENT_FIELD_MON_4
