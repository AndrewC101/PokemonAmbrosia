...
Route16_MapEvents:
	...
	object_event 12,  0, SPRITE_ESPEON, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route16FieldMon5Script, EVENT_FIELD_MON_5
	object_event 14,  0, SPRITE_UMBREON, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route16FieldMon6Script, EVENT_FIELD_MON_6
