...
CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 1000 ; WOBBUFFET
CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 5000 ; CHANSEY
CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 7000 ; DITTO
