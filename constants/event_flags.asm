...
; DevNote - events, lets add more here
    ...
    const EVENT_CINNABAR_LAB_BARRIER_1_DISABLED
    const EVENT_CINNABAR_LAB_BARRIER_2_DISABLED
	...
	const EVENT_HEROES_PASS_PALKIA_GATE_OPEN
	const EVENT_HEROES_PASS_TM_SELFDESTRUCT
	const EVENT_HEROES_PASS_TM_FISSURE
	const EVENT_HEROES_PASS_TM_EARTH_POWER
	const EVENT_BEAT_INVADER_SIEGMEYER
	const EVENT_SILVER_CAVE_ROOM_1_AMBROSIA_1
	const EVENT_SILVER_CAVE_ROOM_1_AMBROSIA_2
	const EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_1
	const EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_2
	const EVENT_SILVER_CAVE_ROOM_2_AMBROSIA_3
	...
	const EVENT_SOLVED_MEW_PUZZLE
	const EVENT_SOLVED_KNOWLEDGE_TRIAL
	const EVENT_SOLVED_FRIENDSHIP_TRIAL
	const EVENT_ROUTE22_TM_EXPLOSION
	const EVENT_CHERRYGROVE_RUINS_TM_THUNDERPUNCH
	const EVENT_CHERRYGROVE_RUINS_TM_FIRE_PUNCH
	const EVENT_CHERRYGROVE_RUINS_TM_ICE_PUNCH
	const EVENT_CHERRYGROVE_RUINS_LEFTOVERS
	const EVENT_CHERRYGROVE_RUINS_MASTER_BALL
	const EVENT_CHERRYGROVE_RUINS_ASSAULT_VEST
	const EVENT_CHERRYGROVE_RUINS_TM_SUBSTITUTE
	const EVENT_CHERRYGROVE_RUINS_AMBROSIA
	const EVENT_CAUGHT_MEW
	const EVENT_GOT_OAK_AERODACTYL_EGG
