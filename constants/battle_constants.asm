...
; shiny dvs
DEF ATKDEFDV_SHINY_1 EQU $FD
DEF SPDSPCDV_SHINY_1 EQU $FE

DEF ATKDEFDV_SHINY_2 EQU $FC
DEF SPDSPCDV_SHINY_2 EQU $FF
...
;	const BATTLETYPE_TUTORIAL           ; used for catching tutorial, a lot of code for this small part of game
	...
	const BATTLETYPE_REMATCH            ; no set no items
	const BATTLETYPE_PERFECT            ; enemy has max dvs and you can't escape - 10% chance of shiny dvs (15, 13, 15, 15)
	...
	const BATTLETYPE_SUPER_BOSS_BATTLE  ; duplicate of boss battle that also bypasses easy-mode benefits
...
; wPlayerSubStatus1 or wEnemySubStatus1 bit flags
	...
	const SUBSTATUS_ENDURE ; not used
...
DEF FIELD_EFFECT_DURATION EQU 6
