...
GoldenrodUnderground_MapEvents:
	...
	object_event 18,  9, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, UndergroundMon1Script, EVENT_FIELD_MON_1
