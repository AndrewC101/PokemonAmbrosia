...
FuchsiaCity_MapEvents:
	...
	object_event 13,  8, SPRITE_FISHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, FuchsiaCityPokefanM, -1
	object_event 16, 14, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, FuchsiaCityTeacher, -1
	...
	object_event 19, 4, SPRITE_SELECTED_PLAYER, SPRITEMOVEDATA_STANDING_LEFT, 2, 2, -1, -1, PAL_NPC_PLAYER, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMP_EVENT_1
	object_event 34, 10, SPRITE_TAUROS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, FuchsiaCityMon1Script, EVENT_FIELD_MON_1
