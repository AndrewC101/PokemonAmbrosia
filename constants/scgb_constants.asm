...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_HALL_OF_ORIGIN
	const PREDEFPAL_DESTINY_TOWER
	const PREDEFPAL_ANCIENT_RUIN
	const PREDEFPAL_WAR_ZONE
	const PREDEFPAL_MUSEUM
	const PREDEFPAL_MANOR
	const PREDEFPAL_ABYSS
