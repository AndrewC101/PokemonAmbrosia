...
CELADONGAMECORNERPRIZEROOM_TM29_COINS EQU 7000
CELADONGAMECORNERPRIZEROOM_TM15_COINS EQU 7000
CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 1000 ; SMEARGLE
CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 3000 ; CHANSEY
CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 5000 ; DITTO
