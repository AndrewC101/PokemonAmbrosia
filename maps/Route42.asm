...
Route42_MapEvents:
	...
	object_event 48,  8, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerHikerBenjamin, -1
	...
	object_event 6,  12, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, Route42FieldMon3Script, EVENT_FIELD_MON_3
	object_event 22,  4, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route42FieldMon4Script, EVENT_FIELD_MON_4
	...
	object_event 5,  6, SPRITE_MAGMAR, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route42FieldMon6Script, EVENT_FIELD_MON_6
