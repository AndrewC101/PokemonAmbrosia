...
; NOVICE level
	...
	db WEAVILE
	db BRIGHTPOWDER
	db FEINT_ATTACK, QUICK_ATTACK, ICE_PUNCH, ROCK_SMASH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65000
...
; LEADER level
    ...
    db VENUSAUR
	db LEFTOVERS
	db SUNNY_DAY, SLUDGE_BOMB, GIGA_DRAIN, EARTH_POWER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db MAGMORTAR
	db EXPERT_BELT
	db FLAMETHROWER, THUNDERBOLT, EARTHQUAKE, GIGA_DRAIN
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db HOUNDOOM
	db CHARCOAL
	db NASTY_PLOT, FIRE_BLAST, DARK_PULSE, FLAMETHROWER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65000
    ...
    db SLOWBRO
	db LEFTOVERS
	db SURF, PSYCHIC_M, CALM_MIND, RECOVER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db ALAKAZAM
	db LEFTOVERS
	db CALM_MIND, PSYCHIC_M, SHADOW_BALL, RECOVER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db WEAVILE
	db LIFE_ORB
	db SLASH, ICE_PUNCH, NIGHT_SLASH, ROCK_SMASH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db URSARING
	db LEFTOVERS
	db AI_RETURN, NIGHT_SLASH, DRAIN_PUNCH, REST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 45000
	...
	db GLISCOR
	db LEFTOVERS
	db EARTHQUAKE, FLY, ROCK_SLIDE, ROOST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db MAGNEZONE
	db MAGNET
	db ZAP_CANNON, FLASH_CANNON, FLASH, EXPLOSION
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
; ELITE level
	...
	db VENUSAUR
	db MIRACLE_SEED
	db SUNNY_DAY, SLUDGE_BOMB, SOLARBEAM, EARTH_POWER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db GLISCOR
	db LEFTOVERS
	db SWORDS_DANCE, EARTHQUAKE, FLY, ROOST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db MISMAGIUS
	db FOCUS_SASH
	db NASTY_PLOT, SHADOW_BALL, THUNDERBOLT, ICY_WIND
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db WEAVILE
	db FOCUS_SASH
	db SWORDS_DANCE, AVALANCHE, NIGHT_SLASH, ROCK_SMASH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
; CHAMP level
    ...
    db CELEBI
	db LEFTOVERS
	db SWORDS_DANCE, THUNDER_WAVE, PSYCHO_SLASH, LEAF_BLADE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db DEOXYS
	db FOCUS_SASH
	db PSYCHO_BOOST, THUNDERBOLT, ICE_BEAM, CLOSE_COMBAT
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db ENTEI
	db LEFTOVERS
	db SACRED_FIRE, CLOSE_COMBAT, EXTREMESPEED, BULK_UP
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
; ============ Final Trainer End - 16 mons ==============
	...
	db GARCHOMP
	db LEFTOVERS
	db OUTRAGE, EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db SALAMENCE
	db FOCUS_SASH
	db OUTRAGE, EARTHQUAKE, IRON_HEAD, DRAGON_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db HAWLUCHA
	db FOCUS_SASH
	db BRAVE_BIRD, HI_JUMP_KICK, ROCK_SLIDE, SWORDS_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db LUCARIO
	db FOCUS_SASH
	db CLOSE_COMBAT, IRON_HEAD, EXTREMESPEED, CRUNCH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db GYARADOS
	db MYSTIC_WATER
	db WATERFALL, EARTHQUAKE, ROCK_SLIDE, DRAGON_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db WEAVILE
	db FOCUS_SASH
	db AVALANCHE, NIGHT_SLASH, ROCK_SMASH, SWORDS_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db SYLVEON
	db LEFTOVERS
	db MOON_BLAST, EARTH_POWER, CALM_MIND, MOONLIGHT
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db BRELOOM
	db FOCUS_SASH
	db SPORE, LEAF_BLADE, DRAIN_PUNCH, SWORDS_DANCE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db GARDEVOIR
	db LEFTOVERS
	db MOON_BLAST, AURA_SPHERE, THUNDERBOLT, CALM_MIND
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db WHIMSICOTT
;	db LEFTOVERS
;	db STUN_SPORE, LEECH_SEED, CONFUSE_RAY, SUBSTITUTE
;	dw 0 ; OT ID
;	dt 0 ; Exp
;	; Stat exp
;	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db CHANDELURE
	db LEFTOVERS
	db FIRE_BLAST, SHADOW_BALL, CALM_MIND, SUBSTITUTE
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db ARCTOVISH
;	db MYSTIC_WATER
;	db SAVAGE_REND, AVALANCHE, ICE_BEAM, SURF
;	dw 0 ; OT ID
;	dt 0 ; Exp
;	; Stat exp
;	bigdw 65500
