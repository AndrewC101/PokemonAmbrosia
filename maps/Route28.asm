...
Route28_MapEvents:
	...
	object_event 25, 14, SPRITE_DRAGON, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route28FieldMon1Script, EVENT_FIELD_MON_1
	object_event  7, 18, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route28FieldMon2Script, EVENT_FIELD_MON_2
	object_event 21, 20, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route28FieldMon3Script, EVENT_FIELD_MON_3
	object_event 15, 20, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route28FieldMon4Script, EVENT_FIELD_MON_4
	object_event 14, 16, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route28FieldMon5Script, EVENT_FIELD_MON_5
	...
	object_event 15, 10, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route28FieldMon7Script, EVENT_FIELD_MON_7
	object_event  9, 10, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, Route28FieldMon8Script, EVENT_FIELD_MON_8
	object_event 29, 12, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route28FieldMon9Script, EVENT_FIELD_MON_9
	object_event  4, 13, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route28FieldMon10Script, EVENT_FIELD_MON_10
