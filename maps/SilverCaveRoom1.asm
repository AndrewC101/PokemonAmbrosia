	...
	const SILVERCAVEROOM1_POKE_BALL5
	const SILVERCAVEROOM1_POKE_BALL6
...
SilverCaveRoom1Ambrosia1:
	itemball AMBROSIA

SilverCaveRoom1Ambrosia2:
	itemball AMBROSIA
...
SilverCaveRoom1_MapEvents:
	...
	def_object_events
	object_event  4,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1MaxElixer, EVENT_SILVER_CAVE_ROOM_1_MAX_ELIXER
	object_event 15, 29, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1Protein, EVENT_SILVER_CAVE_ROOM_1_PROTEIN
	object_event  5, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1EscapeRope, EVENT_SILVER_CAVE_ROOM_1_ESCAPE_ROPE
	object_event  7, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1UltraBall, EVENT_SILVER_CAVE_ROOM_1_ULTRA_BALL
	object_event 15, 23, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1Ambrosia1, EVENT_SILVER_CAVE_ROOM_1_AMBROSIA_1
	object_event 15,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom1Ambrosia2, EVENT_SILVER_CAVE_ROOM_1_AMBROSIA_2
	object_event 14, 28, SPRITE_HOUNDOOM, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon1Script, EVENT_FIELD_MON_1
	...
	object_event 11,  9, SPRITE_SCIZOR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon3Script, EVENT_FIELD_MON_3
	object_event 14,  3, SPRITE_AEGISLASH, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon4Script, EVENT_FIELD_MON_4
	object_event  2, 29, SPRITE_EXCADRILL, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon5Script, EVENT_FIELD_MON_5
	...
	object_event 16, 19, SPRITE_GENGAR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon7Script, EVENT_FIELD_MON_7
	...
	object_event  4,  3, SPRITE_MAMOSWINE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom1FieldMon10Script, EVENT_FIELD_MON_10
