object_const_def
	...
	const CHERRYGROVERUINS_TM_SUBSTITUTE
...
CherrygroveRuins_MapEvents:
	...
	object_event 18,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, CherrygroveRuinsTMSubstitute, EVENT_CHERRYGROVE_RUINS_TM_SUBSTITUTE
