...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    CHARIZARD,       SET_UP_DOLL,       EVENT_DECO_UNOWN_DOLL,              SPRITE_CHARIZARD
	decoration DECO_DOLL,    MR__MIME,        SET_UP_DOLL,       EVENT_DECO_MR_MIMIE_DOLL,           SPRITE_JYNX
	decoration DECO_DOLL,    CROBAT,          SET_UP_DOLL,       EVENT_DECO_CROBAT_DOLL,             SPRITE_ZUBAT
	decoration DECO_DOLL,    GENGAR,          SET_UP_DOLL,       EVENT_DECO_GENGAR_DOLL,             SPRITE_GENGAR
	decoration DECO_DOLL,    STARMIE,         SET_UP_DOLL,       EVENT_DECO_STARMIE_DOLL,            SPRITE_STARMIE
