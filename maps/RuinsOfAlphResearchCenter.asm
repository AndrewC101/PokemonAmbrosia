...
RuinsOfAlphResearchCenter_MapEvents:
	...
	object_event  5,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_WANDER, 2, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, RuinsOfAlphResearchCenterScientist2Script, -1
