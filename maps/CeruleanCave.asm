...
CeruleanCaveFieldMon2Script:
	trainer BAXCALIBUR, FIELD_MON, EVENT_FIELD_MON_2, CeruleanCavePokemonAttacksText, 75, 0, .script
.script
...
KingambitScript:
	...
	loadwildmon KINGAMBIT, 70
	startbattle
	reloadmapafterbattle
	setevent EVENT_TEMP_EVENT_1
	disappear CERULEANCAVE_KINGAMBIT
	end
...
CeruleanCave_MapEvents:
	...
	object_event 15, 23, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, KingambitScript, EVENT_TEMP_EVENT_1
	object_event 27, 57, SPRITE_REGIGIGAS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, RegigigasScript, EVENT_CAUGHT_REGIGIGAS
