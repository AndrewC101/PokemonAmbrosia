DEF CELADONGAMECORNERPRIZEROOM_TM32_COINS EQU 4000
DEF CELADONGAMECORNERPRIZEROOM_TM29_COINS EQU 7000
DEF CELADONGAMECORNERPRIZEROOM_TM15_COINS EQU 7000
DEF CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 1000 ; SMEARGLE
DEF CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 3000 ; CHANSEY
DEF CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 5000 ; DITTO
...
.MenuData:
	db STATICMENU_CURSOR ; flags
	db 4 ; items
	db "Smeargle  {d:CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS}@"
