...
.normal
	...
	loadtrainer NURSE, JOY1
	sjump .begin
.joy2
    loadtrainer NURSE, JOY2
    sjump .begin
.joy3
    loadtrainer NURSE, JOY3
    sjump .begin
.joy4
    loadtrainer NURSE, JOY4
    ; fallthrough
.begin
	startbattle
	ifequal LOSE, .lose
...
Route5_MapEvents:
	...
	object_event  7, 14, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, Route5TrainerScript1, -1
	object_event 12, 12, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, Route5TrainerScript2, -1
