...
Route40_MapEvents:
	...
	object_event  8, 10, SPRITE_BEAUTY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, MonicaScript, EVENT_ROUTE_40_MONICA_OF_MONDAY
