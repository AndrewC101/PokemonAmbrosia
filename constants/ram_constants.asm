...
; wOptions2::
	const_def
	const BATTLE_INFO          ; 0
	const MINIMUM_BATTLE_TEXT  ; 1
DEF FAST_BATTLES EQU MINIMUM_BATTLE_TEXT ; compatibility alias
DEF OVERWORLD_SPEED_SHIFT EQU 2
DEF OVERWORLD_SPEED_MASK EQU %00001100
DEF BATTLE_ENGINE_SPEED_SHIFT EQU 4
DEF BATTLE_ENGINE_SPEED_MASK EQU %00110000
DEF GAME_SPEED_X1 EQU 0
DEF GAME_SPEED_X2 EQU 1
DEF GAME_SPEED_X4 EQU 2
DEF NUM_GAME_SPEED_OPTIONS EQU 3
...
; wPlayerComplexionChoice::
	const_def
	const PLAYER_COMPLEXION_LIGHTER
	const PLAYER_COMPLEXION_DARKER
DEF NUM_PLAYER_COMPLEXIONS EQU const_value
...
; wPlayerColor::
	...
	const PLAYER_COLOR_YELLOW
	const PLAYER_COLOR_PINK
	const PLAYER_COLOR_PURPLE
	const PLAYER_COLOR_ORANGE
	const PLAYER_COLOR_DARK_GREY
DEF NUM_PLAYER_BASE_COLORS EQU const_value
	const PLAYER_COLOR_DARKER_RED
	const PLAYER_COLOR_DARKER_BLUE
	const PLAYER_COLOR_DARKER_GREEN
	const PLAYER_COLOR_DARKER_BROWN
	const PLAYER_COLOR_DARKER_SILVER
	const PLAYER_COLOR_DARKER_YELLOW
	const PLAYER_COLOR_DARKER_PINK
	const PLAYER_COLOR_DARKER_PURPLE
	const PLAYER_COLOR_DARKER_ORANGE
	const PLAYER_COLOR_DARKER_DARK_GREY
DEF NUM_PLAYER_COLORS EQU const_value
	assert NUM_PLAYER_COLORS == NUM_PLAYER_BASE_COLORS * NUM_PLAYER_COMPLEXIONS

; wPlayerSpriteChoice::
	const_def
	const PLAYER_SPRITE_DEFAULT
	const PLAYER_SPRITE_SILVER
	const PLAYER_SPRITE_BLUE
	const PLAYER_SPRITE_FALKNER
	const PLAYER_SPRITE_LANCE
	const PLAYER_SPRITE_BRUNO
	const PLAYER_SPRITE_GIOVANNI
	const PLAYER_SPRITE_EUSINE
	const PLAYER_SPRITE_MISTY
	const PLAYER_SPRITE_CLAIR
	const PLAYER_SPRITE_ROCKET_GIRL
	const PLAYER_SPRITE_SABRINA
	const PLAYER_SPRITE_WHITNEY
	const PLAYER_SPRITE_JASMINE
	const PLAYER_SPRITE_ERIKA
	const PLAYER_SPRITE_MORTY
	const PLAYER_SPRITE_ASH
	const PLAYER_SPRITE_KIMONO_GIRL
	const PLAYER_SPRITE_LASS
DEF NUM_PLAYER_SPRITES EQU const_value
...
; registered item slots
DEF NUM_REGISTERED_ITEMS EQU 4
