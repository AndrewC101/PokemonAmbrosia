...
LinkReceptionistScript_TimeCapsule:
	jumptextfaceplayer timeCapsuleForSaleText

timeCapsuleForSaleText:
	text "The funding for"
	line "these time"
	cont "capsules has run"
	cont "out."
	para "Until someone can"
	line "come up with a"
	cont "good use for these"
	cont "I'm afraid they"
	cont "are a waste of"
	cont "space."
	done
...
Pokecenter2F_MapEvents:
	...
	object_event  1,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Pokecenter2FOfficerScript, EVENT_MYSTERY_GIFT_DELIVERY_GUY
