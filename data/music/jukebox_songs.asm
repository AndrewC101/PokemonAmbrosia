...
JukeboxSongs::
	...
	db MUSIC_LAKE_OF_RAGE, MUSIC_ROCKET_HIDEOUT, MUSIC_DRAGONS_DEN, MUSIC_VICTORY_ROAD, MUSIC_RED_DUNGEON
	db MUSIC_INDIGO_PLATEAU, MUSIC_RED_INDIGO_PLATEAU, MUSIC_BATTLE_TOWER_LOBBY, MUSIC_MAGNET_TRAIN, MUSIC_PALLET_TOWN
	db MUSIC_VIRIDIAN_CITY, MUSIC_DUNGEON2, MUSIC_MT_MOON, MUSIC_MT_MOON_SQUARE, MUSIC_VERMILION_CITY
	db MUSIC_CELADON_CITY, MUSIC_GAME_CORNER, MUSIC_RED_LAVENDER, MUSIC_CINNABAR_MANSION, MUSIC_DANCING_HALL, MUSIC_GYM
	...
	db MUSIC_RUINS_OF_ALPH_RADIO, MUSIC_LAKE_OF_RAGE_ROCKET_RADIO, MUSIC_CAPTURE, MUSIC_MOM, MUSIC_POKEMON_LULLABY
	db MUSIC_POKEMON_MARCH, MUSIC_MAIN_MENU, MUSIC_BUG_CATCHING_CONTEST_RANKING
	db MUSIC_MOBILE_ADAPTER_MENU, MUSIC_ROCKET_OVERTURE, MUSIC_MAD_WORLD, MUSIC_MISTY_MOUNTAIN, MUSIC_LUGIA_SONG
	db MUSIC_BATTLE_TOWER_THEME, MUSIC_TRAINER_VICTORY, MUSIC_WILD_VICTORY, MUSIC_GYM_VICTORY
	db MUSIC_JOHTO_WILD_BATTLE, MUSIC_JOHTO_WILD_BATTLE_NIGHT
	db MUSIC_JOHTO_TRAINER_BATTLE, MUSIC_KANTO_WILD_BATTLE, MUSIC_KANTO_TRAINER_BATTLE, MUSIC_ROCKET_BATTLE
	...
	db MUSIC_HO_OH_BATTLE, MUSIC_GUILE_THEME
...
.CinnabarMansion:     db "Cinnabar Lab@"
.Dungeon2:            db "Viridian Forest@"
