...
MasterAdamLoseAfterBattleText:
	...
	line "very far."
	para "Don't give up!"
	para "Keep trying new"
	line "things, keep"
	cont "innovating."
	para "Soon nothing will"
	line "stop you."
	done
...
DestinySquare_MapEvents:
	...
	object_event  8, 18, SPRITE_BEAUTY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, MasterCrystalScript, -1
	object_event  9, 22, SPRITE_CLAIR, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, MasterCynthiaScript, -1
