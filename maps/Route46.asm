...
Route46_MapEvents:
	...
	def_object_events
	object_event 15,  6, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, TrainerHikerBailey, -1
	...
	object_event  7, 26, SPRITE_GEODUDE, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route46FieldMon2Script, EVENT_FIELD_MON_2
	object_event  8, 21, SPRITE_ZUBAT, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route46FieldMon3Script, EVENT_FIELD_MON_3
	object_event  2, 18, SPRITE_DRATINI, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route46FieldMon4Script, EVENT_FIELD_MON_4
