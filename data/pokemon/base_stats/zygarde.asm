	...
	; tm/hm learnset
	tmhm DRAIN_PUNCH, ICE_PUNCH, FIRE_PUNCH, THUNDERPUNCH, HEADBUTT, BODY_SLAM, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, HYPER_BEAM, PROTECT, SUBSTITUTE, IRON_HEAD, DRAGON_PULSE, RETURN, DOUBLE_EDGE, SLEEP_TALK, SANDSTORM, SWIFT, REST, X_SCISSOR, CUT, STRENGTH, EARTHQUAKE, EARTH_POWER, ROCK_SLIDE, BULK_UP, DIG, FISSURE, HORN_DRILL, TAUNT
	; end
