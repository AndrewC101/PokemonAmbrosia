...
GoldenrodDeptStore3F_MapEvents:
	...
	object_event 12,  5, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, GoldenrodDeptStore3FSuperNerdScript, -1
