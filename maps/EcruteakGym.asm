...
EcruteakGym_MapEvents:
	...
	object_event  7, 15, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, EcruteakGymGuideScript, -1
	...
	object_event  4,  1, SPRITE_GENGAR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, EcruteakGymGengarScript, -1
