...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  MAWILE,      SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $25
	...
	decoration DECO_DOLL,    FRIGIBAX,        SET_UP_DOLL,       EVENT_DECO_CLEFAIRY_DOLL,           SPRITE_FRIGIBAX
	decoration DECO_DOLL,    MUDKIP,          SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,         SPRITE_MUDKIP
	...
	decoration DECO_DOLL,    VENUSAUR,        SET_UP_DOLL,       EVENT_DECO_MAGIKARP_DOLL,           SPRITE_VENUSAUR
	decoration DECO_DOLL,    CHARIZARD,       SET_UP_DOLL,       EVENT_DECO_GROWLITHE_DOLL,          SPRITE_CHARIZARD
	decoration DECO_DOLL,    BLASTOISE,       SET_UP_DOLL,       EVENT_DECO_MACHOP_DOLL,             SPRITE_BLASTOISE
	decoration DECO_DOLL,    SCEPTILE,        SET_UP_DOLL,       EVENT_DECO_GEODUDE_DOLL,            SPRITE_SCEPTILE
	decoration DECO_DOLL,    GRENINJA,        SET_UP_DOLL,       EVENT_DECO_UNOWN_DOLL,              SPRITE_GRENINJA
	decoration DECO_DOLL,    INFERNAPE,       SET_UP_DOLL,       EVENT_DECO_MR_MIMIE_DOLL,           SPRITE_INFERNAPE
	decoration DECO_DOLL,    GARDEVOIR,       SET_UP_DOLL,       EVENT_DECO_CROBAT_DOLL,             SPRITE_GARDEVOIR
	decoration DECO_DOLL,    SMEARGLE,        SET_UP_DOLL,       EVENT_DECO_GENGAR_DOLL,             SPRITE_SMEARGLE
	decoration DECO_DOLL,    SWAMPERT,        SET_UP_DOLL,       EVENT_DECO_STARMIE_DOLL,            SPRITE_SWAMPERT
	decoration DECO_DOLL,    DRAGONITE,       SET_UP_DOLL,       EVENT_DECO_DRAGONITE_DOLL,          SPRITE_DRAGONITE
	decoration DECO_DOLL,    HO_OH,           SET_UP_DOLL,       EVENT_DECO_HO_OH_DOLL,              SPRITE_HO_OH
	decoration DECO_DOLL,    LUGIA,           SET_UP_DOLL,       EVENT_DECO_LUGIA_DOLL,              SPRITE_LUGIA
	decoration DECO_DOLL,    MEWTWO,          SET_UP_DOLL,       EVENT_DECO_MEWTWO_DOLL,             SPRITE_MEWTWO
	decoration DECO_DOLL,    ARCEUS,          SET_UP_DOLL,       EVENT_DECO_ARCEUS_DOLL,             SPRITE_ARCEUS
