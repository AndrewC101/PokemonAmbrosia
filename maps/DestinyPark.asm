...
DestinyPark_MapEvents:
	...
	def_object_events
	object_event  4,  8, SPRITE_BROCK, SPRITEMOVEDATA_STANDING_DOWN, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, MAPOBJECT_DARK_SKIN, MasterBrockScript, -1
	object_event  4,  2, SPRITE_MISTY, SPRITEMOVEDATA_STANDING_DOWN, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MasterMistyScript, -1
	object_event 17,  5, SPRITE_SURGE, SPRITEMOVEDATA_STANDING_RIGHT, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, MasterSurgeScript, -1
	object_event 33,  2, SPRITE_ERIKA, SPRITEMOVEDATA_STANDING_DOWN, 2, 2, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, MasterErikaScript, -1
	...
	object_event  5, 22, SPRITE_BUGSY, SPRITEMOVEDATA_STANDING_DOWN, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MasterBugsyScript, -1
	...
	object_event 19, 22, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MasterJasmineScript, -1
