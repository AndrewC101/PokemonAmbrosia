...
Route20_MapEvents:
	...
	object_event 20, 15, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon1Script, EVENT_FIELD_MON_1
	object_event 19,  4, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon2Script, EVENT_FIELD_MON_2
	object_event 54,  6, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon3Script, EVENT_FIELD_MON_3
	object_event  6,  5, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon4Script, EVENT_FIELD_MON_4
	object_event  4, 14, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon5Script, EVENT_FIELD_MON_5
	object_event 54, 15, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route20FieldMon6Script, EVENT_FIELD_MON_6
	object_event 51,  3, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route20FieldMon7Script, EVENT_FIELD_MON_7
	object_event 18, 10, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route20FieldMon8Script, EVENT_FIELD_MON_8
